...
use MfaFast\Application;
use MfaFast\Http\Request;
use MfaFast\Support\Hash;
use MfaFast\Http\Response;
use MfaFast\Validation\Validator;
...
if (!function_exists('app')) {
    function app()
    {
        //for singleton use app instance only one variable in memory and reuse it
